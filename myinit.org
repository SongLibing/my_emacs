...
#+BEGIN_SRC emacs-lisp
  ...
  (custom-set-variables '(spacemacs-theme-comment-bg nil)
                        '(spacemacs-theme-custom-colors '((bg1 . "#300a24")
                                                          (comment . "#7fff00"))))
    ...
    (projectile-with-default-dir (projectile-ensure-project (projectile-project-root))
      (async-shell-command
       "CC=clang CXX=clang++ cmake . -DCMAKE_EXPORT_COMPILE_COMMANDS=ON \
        -DFORCE_INSOURCE_BUILD=1 -DWITH_BOOST=~/work/boost; \
        make GenError; make GenBison_mysql; make GenBison_hints")))
#+END_SRC
...
* Misc packages
  ...
  :init (setq hungry-delete-except-modes
           '(help-mode minibuffer-mode minibuffer-inactive-mode))
  )
