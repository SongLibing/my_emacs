...
#+BEGIN_SRC emacs-lisp
  ...
  (global-set-key (kbd "C-M-f") 'set_window_dedicated)
...
#+BEGIN_SRC emacs-lisp
  ...
  (custom-set-faces
    '(term-color-blue ((t (:background "blue2" :foreground "light sky blue")))))
#+END_SRC
* Swiper / Ivy / Counsel
...
#+BEGIN_SRC emacs-lisp
  (defun mysql_cmake()
    ...
    (projectile-with-default-dir (projectile-ensure-project (projectile-project-root))
      (async-shell-command
       "cmake . -DCMAKE_EXPORT_COMPILE_COMMANDS=ON -DFORCE_INSOURCE_BUILD=1 -DWITH_BOOST=~/work/boost")))
#+END_SRC
...
(global-set-key (kbd "M-g a") 'magit-blame-mode)
